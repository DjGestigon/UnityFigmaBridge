...
namespace UnityFigmaBridge.Editor.Settings
{
    public class UnityFigmaBridgeSettings : ScriptableObject
    {
        ...
        [Tooltip("If checked, the importer will only import the specific node ID found in the 'Figma Document Url' (eg, ?node-id=123:456).")]
        public bool ImportOnlySpecificNodeFromUrl = false;

        [Header("Debug")]
        [Tooltip("Write downloaded figma file JSON to a file for debugging")]
        public bool WriteFileJson = false;
